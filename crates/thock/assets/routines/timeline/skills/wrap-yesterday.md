...
- **The target day is yesterday** (today minus one day), so the note is yesterday's daily note (same config-resolved naming as Wrap Today), anything step 3 pulls in is yesterday's, and the review appends to yesterday's note. If the note doesn't exist, still create it, and note that the day went uncaptured.
